...
private List<Book> listOfBooks = new ArrayList<Book>();
	...
	public BookRepositoryImpl() {
		...
		book3.setDescription(
				"어도비 XD 프로그램을 통해 UI/UX 디자인을 배우고자 하는 예비 디자이너의 눈높이에 맞게 기본적인 도구를 활용한 아이콘 디자인과 웹&앱 페이지 디자인, UI디자인, 앱 디자인에 애니메이션과 인터랙션을 적용한 프로토타이핑을 학습합니다.");
	...
	public Book getBookById(String bookId) {
		...
		if(bookInfo == null)
			throw new BookIdException(bookId);	//검색한 도서 아이디가 없는경우 예외 처리 클래스 호출 BookIdException
		return bookInfo;
	}
